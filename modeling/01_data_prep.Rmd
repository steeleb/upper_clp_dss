...
DOI = "14397591"
data_version = "v.2024.12.10"


source("src/grab_zenodo_data.R")


ross_water_chem <- most_recent_chem%>%
...
FC_chem <- read_csv("data/FC_clp_chem/UCLP_CWQMP_database_2022-24.csv", show_col_types = F)%>%
  select(site_code = ShortDesc, 
         Date, 
         Cl, 
         TOC, NO3_N, 
         PO4 = oPhos,
