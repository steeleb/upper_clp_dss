...
records. The sites here are those that are on the mainstem and not as affected by
reservoir signals. In particular, we drop JWC since it is primarily reservoir fed.
